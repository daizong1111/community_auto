...
class TestAdd(BaseCase):
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("新增-成功", "安徽省/合肥市/庐阳区", "中电数智社区（演示）", "河北省公安局", "商业", "中电数智物业", "蔡文",
             ...
             "刘富豪", "石童涛", "128113", "15855211922", "383", "物管小区", "北京市义安区街道1005号", r"C:\Users\Administrator\Pictures\111.png", "3397","20030","18900", "北京市义安区街道1005号", "本小区属于高档富人小区，闲人免进", "{116.794571,33.971816},{116.794585,33.972089},{116.794600,33.972037},{116.794781,33.971885},{116.794783,33.971750},{116.794783,33.971750}", "116.794677","33.971920"),
    ...
    def test_add_success(self, 小区信息页面,
        ...
        # 断言操作成功字样在页面出现
        expect(小区信息页面.page.get_by_text("操作成功")).to_be_visible(timeout=5000)
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("新增-失败-去重校验", "安徽省/合肥市/庐阳区", "中电数智社区（演示）", "河北省公安局", "商业", "中电数智物业",
             "蔡文",
             "13865546155", "340421199711170022", "河北省京东直营家电采购厂",
             "刘富豪", "石童涛", "1281130022", "15855211922", "002", "物管小区",
             "北京市义安区街道1005号", r"C:\Users\Administrator\Pictures\111.png", "3397", "20030", "18900",
             "北京市义安区街道1005号", "本小区属于高档富人小区，闲人免进",
             "{116.794571,33.971816},{116.794585,33.972089},{116.794600,33.972037},{116.794781,33.971885},{116.794783,33.971750},{116.794783,33.971750}",
             "116.794677", "33.971920")
    ...
    @pytest.mark.parametrize(
        ...
        [
            #     ("新增-成功", "安徽省/合肥市/庐阳区", "中电数智社区（演示）", "河北省公安局", "商业", "中电数智物业", "蔡文",
            #      "13865546155", "340421199711170022", "河北省京东直营家电采购厂",
            #      "刘富豪", "石童涛", "1281130022", "15855211922", "383", "物管小区", "北京市义安区街道1005号", r"C:\Users\Administrator\Pictures\111.png", "3397","20030","18900", "北京市义安区街道1005号", "本小区属于高档富人小区，闲人免进", "{116.794571,33.971816},{116.794585,33.972089},{116.794600,33.972037},{116.794781,33.971885},{116.794783,33.971750},{116.794783,33.971750}", "116.794677","33.971920"),
            #
...
class TestEdit(BaseCase):
    @pytest.mark.parametrize(
        ...
        [
            ("天王巷小区", "修改-成功", "安徽省/合肥市/庐阳区", "中电数智社区（演示）", "河北省公安局", "商业",
             "中电数智物业", "蔡文",
             "13865546155", "340421199711170022", "河北省京东直营家电采购厂",
             "刘富豪", "石童涛", "1281130022", "15855211922", "383", "物管小区",
             "北京市义安区街道1005号", r"C:\Users\Administrator\Pictures\111.png", "3397", "20030", "18900",
    ...
    def test_edit_success(self, 小区信息页面,
        ...
        # 填写表单信息
        小区信息页面.快捷操作_填写表单_增加根据数据类确定唯一表单版(行政区域=行政区域,物业管理员=物业管理员)
...
class TestDelete(BaseCase):
    ...
    def test_delete_success(self, 小区信息页面, db_connection, 小区名称_待删除):
        ...
        # 查找待删除的记录
        小区信息页面.快捷操作_填写表单_增加根据数据类确定唯一表单版(小区类型="全部", 管理类别="全部", 小区名称=小区名称_待删除)
        小区信息页面.click_button("搜索")
    ...
    def test_delete_cancel(self, 小区信息页面, db_connection, 小区名称_待删除):
        ...
        数据库中数据量_删除前 = 数据库中数据量_删除前[0]["count"]
        # 查找待删除的记录
        小区信息页面.快捷操作_填写表单_增加根据数据类确定唯一表单版(小区类型="全部", 管理类别="全部",
                                                                    小区名称=小区名称_待删除)
        小区信息页面.click_button("搜索")
        _, 表格中数据量_删除前 = 小区信息页面.get_table_data()
        self.log_step("统计删除操作前表格行数")
